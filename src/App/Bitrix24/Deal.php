...
trait Deal
{
    ...
    /**
     * Возвращает описание полей товаров в cделке
     * @return array
     */
    ...
    /**
     * Возвращает товары, связанные со сделкой по ID сделки
     * @param  int|string $dealId ID сделки
     * @return array
     */
    ...
    /**
     * Устанавливает товары, связанные со сделкой по ID сделки
     * @param  int|string $dealId ID сделки
    ...
    /**
     * Пакетно добавляет сделки c товарами
    ...
    /**
     * Пакетно обновляет сделки c товарами
     * @param  array $deals Массив сделок (поля связанных сущностей [ 'COMPANY_ID', 'CONTACT_ID', 'PRODUCTS' ])
